...
class mydsp : public dsp {
  ...
  public:
	static void metadata(Meta* m) 	{ 
		m->declare("name", "tsarWeededUpTenthHz");
	...
	virtual void instanceInit(int samplingFreq) {
		...
		fConst2 = cos((6.283185307179586 * ((0.1 + fConst0) / double(iConst1))));
		fslider0 = 0.99999;
	...
	virtual void compute (int count, FAUSTFLOAT** input, FAUSTFLOAT** output) {
		...
		double 	fSlow19 = ((pow(fConst8,fSlow6) * fSlow5) * fSlow18);
		...
		double 	fSlow24 = ((pow(fConst12,fSlow6) * fSlow5) * fSlow23);
		...
		double 	fSlow39 = ((pow(fConst24,fSlow6) * fSlow5) * fSlow38);
		...
		double 	fSlow44 = ((pow(fConst28,fSlow6) * fSlow5) * fSlow43);
		...
		double 	fSlow129 = ((pow(fConst96,fSlow6) * fSlow5) * fSlow128);
		...
		double 	fSlow134 = ((pow(fConst100,fSlow6) * fSlow5) * fSlow133);
		...
		double 	fSlow315 = ((fSlow5 * pow(fConst245,fSlow6)) * fSlow223);
		double 	fSlow316 = ((fSlow5 * pow(fConst246,fSlow6)) * fSlow228);
		double 	fSlow317 = ((fSlow5 * pow(fConst247,fSlow6)) * fSlow233);
		double 	fSlow318 = ((fSlow5 * pow(fConst248,fSlow6)) * fSlow238);
		double 	fSlow319 = ((fSlow5 * pow(fConst249,fSlow6)) * fSlow243);
		double 	fSlow320 = ((fSlow5 * pow(fConst250,fSlow6)) * fSlow248);
		double 	fSlow321 = ((fSlow5 * pow(fConst251,fSlow6)) * fSlow253);
		double 	fSlow322 = ((fSlow5 * pow(fConst252,fSlow6)) * fSlow258);
		double 	fSlow323 = ((fSlow5 * pow(fConst253,fSlow6)) * fSlow263);
		double 	fSlow324 = ((fSlow5 * pow(fConst254,fSlow6)) * fSlow268);
		double 	fSlow325 = ((fSlow5 * pow(fConst255,fSlow6)) * fSlow273);
		double 	fSlow326 = ((fSlow5 * pow(fConst256,fSlow6)) * fSlow278);
		double 	fSlow327 = ((fSlow5 * pow(fConst257,fSlow6)) * fSlow283);
		double 	fSlow328 = ((pow(fConst258,fSlow6) * fSlow5) * fSlow288);
		double 	fSlow329 = ((pow(fConst259,fSlow6) * fSlow5) * fSlow293);
		double 	fSlow330 = ((pow(fConst260,fSlow6) * fSlow5) * fSlow298);
		double 	fSlow331 = ((fSlow5 * pow(fConst261,fSlow6)) * fSlow303);
		double 	fSlow332 = ((fSlow5 * pow(fConst262,fSlow6)) * fSlow308);
		double 	fSlow333 = ((fSlow5 * pow(fConst263,fSlow6)) * fSlow313);
		double 	fSlow334 = ((fSlow5 * pow(fConst264,fSlow6)) * fSlow218);
		double 	fSlow335 = ((fSlow5 * pow(fConst265,fSlow6)) * fSlow213);
		double 	fSlow336 = ((fSlow5 * pow(fConst266,fSlow6)) * fSlow208);
		double 	fSlow337 = ((fSlow5 * pow(fConst267,fSlow6)) * fSlow203);
		double 	fSlow338 = ((fSlow5 * pow(fConst268,fSlow6)) * fSlow198);
		double 	fSlow339 = ((fSlow5 * pow(fConst269,fSlow6)) * fSlow193);
		double 	fSlow340 = ((fSlow5 * pow(fConst270,fSlow6)) * fSlow188);
		double 	fSlow341 = ((fSlow5 * pow(fConst271,fSlow6)) * fSlow183);
		double 	fSlow342 = ((fSlow5 * pow(fConst272,fSlow6)) * fSlow178);
		double 	fSlow343 = ((fSlow5 * pow(fConst273,fSlow6)) * fSlow173);
		double 	fSlow344 = ((fSlow5 * pow(fConst274,fSlow6)) * fSlow168);
		double 	fSlow345 = ((fSlow5 * pow(fConst275,fSlow6)) * fSlow163);
		double 	fSlow346 = ((fSlow5 * pow(fConst276,fSlow6)) * fSlow158);
		double 	fSlow347 = ((fSlow5 * pow(fConst277,fSlow6)) * fSlow153);
		double 	fSlow348 = ((fSlow5 * pow(fConst278,fSlow6)) * fSlow148);
		double 	fSlow349 = ((fSlow5 * pow(fConst279,fSlow6)) * fSlow143);
		double 	fSlow350 = ((fSlow5 * pow(fConst280,fSlow6)) * fSlow138);
		double 	fSlow351 = ((fSlow5 * pow(fConst281,fSlow6)) * fSlow133);
		double 	fSlow352 = ((fSlow5 * pow(fConst282,fSlow6)) * fSlow128);
		double 	fSlow353 = ((fSlow5 * pow(fConst283,fSlow6)) * fSlow123);
		double 	fSlow354 = ((fSlow5 * pow(fConst284,fSlow6)) * fSlow118);
		double 	fSlow355 = ((fSlow5 * pow(fConst285,fSlow6)) * fSlow113);
		double 	fSlow356 = ((fSlow5 * pow(fConst286,fSlow6)) * fSlow108);
		double 	fSlow357 = ((fSlow5 * pow(fConst287,fSlow6)) * fSlow103);
		double 	fSlow358 = ((fSlow5 * pow(fConst288,fSlow6)) * fSlow98);
		double 	fSlow359 = ((fSlow5 * pow(fConst289,fSlow6)) * fSlow93);
		double 	fSlow360 = ((fSlow5 * pow(fConst290,fSlow6)) * fSlow88);
		double 	fSlow361 = ((fSlow5 * pow(fConst291,fSlow6)) * fSlow83);
		double 	fSlow362 = ((fSlow5 * pow(fConst292,fSlow6)) * fSlow78);
		double 	fSlow363 = ((fSlow5 * pow(fConst293,fSlow6)) * fSlow73);
		double 	fSlow364 = ((fSlow5 * pow(fConst294,fSlow6)) * fSlow68);
		double 	fSlow365 = ((fSlow5 * pow(fConst295,fSlow6)) * fSlow63);
		double 	fSlow366 = ((fSlow5 * pow(fConst296,fSlow6)) * fSlow58);
		double 	fSlow367 = ((fSlow5 * pow(fConst297,fSlow6)) * fSlow53);
		double 	fSlow368 = ((fSlow5 * pow(fConst298,fSlow6)) * fSlow48);
		double 	fSlow369 = ((fSlow5 * pow(fConst299,fSlow6)) * fSlow43);
		double 	fSlow370 = ((fSlow5 * pow(fConst300,fSlow6)) * fSlow38);
		double 	fSlow371 = ((fSlow5 * pow(fConst301,fSlow6)) * fSlow33);
		double 	fSlow372 = ((fSlow5 * pow(fConst302,fSlow6)) * fSlow28);
		double 	fSlow373 = ((fSlow5 * pow(fConst303,fSlow6)) * fSlow23);
		double 	fSlow374 = ((fSlow5 * pow(fConst304,fSlow6)) * fSlow18);
		double 	fSlow375 = ((fSlow5 * pow(fConst305,fSlow6)) * fSlow9);
		...
		double 	fSlow418 = ((fSlow5 * pow(fConst348,fSlow6)) * fSlow308);
		double 	fSlow419 = ((fSlow5 * pow(fConst349,fSlow6)) * fSlow313);
		double 	fSlow420 = ((fSlow5 * pow(fConst350,fSlow6)) * fSlow303);
		double 	fSlow421 = ((fSlow5 * pow(fConst351,fSlow6)) * fSlow298);
		double 	fSlow422 = ((fSlow5 * pow(fConst352,fSlow6)) * fSlow293);
		double 	fSlow423 = ((fSlow5 * pow(fConst353,fSlow6)) * fSlow288);
		double 	fSlow424 = ((fSlow5 * pow(fConst354,fSlow6)) * fSlow283);
		double 	fSlow425 = ((fSlow5 * pow(fConst355,fSlow6)) * fSlow278);
		double 	fSlow426 = ((fSlow5 * pow(fConst356,fSlow6)) * fSlow273);
		double 	fSlow427 = ((fSlow5 * pow(fConst357,fSlow6)) * fSlow268);
		double 	fSlow428 = ((fSlow5 * pow(fConst358,fSlow6)) * fSlow263);
		double 	fSlow429 = ((fSlow5 * pow(fConst359,fSlow6)) * fSlow258);
		double 	fSlow430 = ((fSlow5 * pow(fConst360,fSlow6)) * fSlow253);
		double 	fSlow431 = ((fSlow5 * pow(fConst361,fSlow6)) * fSlow248);
		double 	fSlow432 = ((fSlow5 * pow(fConst362,fSlow6)) * fSlow243);
		double 	fSlow433 = ((fSlow5 * pow(fConst363,fSlow6)) * fSlow238);
		double 	fSlow434 = ((fSlow5 * pow(fConst364,fSlow6)) * fSlow233);
		double 	fSlow435 = ((fSlow5 * pow(fConst365,fSlow6)) * fSlow228);
		double 	fSlow436 = ((fSlow5 * pow(fConst366,fSlow6)) * fSlow223);
		...
		for (int i=0; i<count; i++) {
			...
			fRec65[0] = (0 - (((fSlow221 * fRec65[1]) + (fSlow222 * fRec65[2])) - (fSlow315 * fRec1[0])));
			fRec66[0] = (0 - (((fSlow226 * fRec66[1]) + (fSlow227 * fRec66[2])) - (fSlow316 * fRec1[0])));
			fRec67[0] = (0 - (((fSlow231 * fRec67[1]) + (fSlow232 * fRec67[2])) - (fSlow317 * fRec1[0])));
			fRec68[0] = (0 - (((fSlow236 * fRec68[1]) + (fSlow237 * fRec68[2])) - (fSlow318 * fRec1[0])));
			fRec69[0] = (0 - (((fSlow241 * fRec69[1]) + (fSlow242 * fRec69[2])) - (fSlow319 * fRec1[0])));
			fRec70[0] = (0 - (((fSlow246 * fRec70[1]) + (fSlow247 * fRec70[2])) - (fSlow320 * fRec1[0])));
			fRec71[0] = (0 - (((fSlow251 * fRec71[1]) + (fSlow252 * fRec71[2])) - (fSlow321 * fRec1[0])));
			fRec72[0] = (0 - (((fSlow256 * fRec72[1]) + (fSlow257 * fRec72[2])) - (fSlow322 * fRec1[0])));
			fRec73[0] = (0 - (((fSlow261 * fRec73[1]) + (fSlow262 * fRec73[2])) - (fSlow323 * fRec1[0])));
			fRec74[0] = (0 - (((fSlow266 * fRec74[1]) + (fSlow267 * fRec74[2])) - (fSlow324 * fRec1[0])));
			fRec75[0] = (0 - (((fSlow271 * fRec75[1]) + (fSlow272 * fRec75[2])) - (fSlow325 * fRec1[0])));
			fRec76[0] = (0 - (((fSlow276 * fRec76[1]) + (fSlow277 * fRec76[2])) - (fSlow326 * fRec1[0])));
			fRec77[0] = (0 - (((fSlow281 * fRec77[1]) + (fSlow282 * fRec77[2])) - (fSlow327 * fRec1[0])));
			fRec78[0] = (0 - (((fSlow286 * fRec78[1]) + (fSlow287 * fRec78[2])) - (fSlow328 * fRec1[0])));
			fRec79[0] = (0 - (((fSlow291 * fRec79[1]) + (fSlow292 * fRec79[2])) - (fSlow329 * fRec1[0])));
			fRec80[0] = (0 - (((fSlow296 * fRec80[1]) + (fSlow297 * fRec80[2])) - (fSlow330 * fRec1[0])));
			fRec81[0] = (0 - (((fSlow301 * fRec81[1]) + (fSlow302 * fRec81[2])) - (fSlow331 * fRec1[0])));
			fRec82[0] = (0 - (((fSlow306 * fRec82[1]) + (fSlow307 * fRec82[2])) - (fSlow332 * fRec1[0])));
			fRec83[0] = (0 - (((fSlow311 * fRec83[1]) + (fSlow312 * fRec83[2])) - (fSlow333 * fRec1[0])));
			fRec84[0] = (0 - (((fSlow217 * fRec84[2]) + (fSlow216 * fRec84[1])) - (fSlow334 * fRec1[0])));
			fRec85[0] = (0 - (((fSlow212 * fRec85[2]) + (fSlow211 * fRec85[1])) - (fSlow335 * fRec1[0])));
			fRec86[0] = (0 - (((fSlow206 * fRec86[1]) + (fSlow207 * fRec86[2])) - (fSlow336 * fRec1[0])));
			fRec87[0] = (0 - (((fSlow201 * fRec87[1]) + (fSlow202 * fRec87[2])) - (fSlow337 * fRec1[0])));
			fRec88[0] = (0 - (((fSlow196 * fRec88[1]) + (fSlow197 * fRec88[2])) - (fSlow338 * fRec1[0])));
			fRec89[0] = (0 - (((fSlow191 * fRec89[1]) + (fSlow192 * fRec89[2])) - (fSlow339 * fRec1[0])));
			fRec90[0] = (0 - (((fSlow186 * fRec90[1]) + (fSlow187 * fRec90[2])) - (fSlow340 * fRec1[0])));
			fRec91[0] = (0 - (((fSlow181 * fRec91[1]) + (fSlow182 * fRec91[2])) - (fSlow341 * fRec1[0])));
			fRec92[0] = (0 - (((fSlow176 * fRec92[1]) + (fSlow177 * fRec92[2])) - (fSlow342 * fRec1[0])));
			fRec93[0] = (0 - (((fSlow171 * fRec93[1]) + (fSlow172 * fRec93[2])) - (fSlow343 * fRec1[0])));
			fRec94[0] = (0 - (((fSlow166 * fRec94[1]) + (fSlow167 * fRec94[2])) - (fSlow344 * fRec1[0])));
			fRec95[0] = (0 - (((fSlow161 * fRec95[1]) + (fSlow162 * fRec95[2])) - (fSlow345 * fRec1[0])));
			fRec96[0] = (0 - (((fSlow156 * fRec96[1]) + (fSlow157 * fRec96[2])) - (fSlow346 * fRec1[0])));
			fRec97[0] = (0 - (((fSlow151 * fRec97[1]) + (fSlow152 * fRec97[2])) - (fSlow347 * fRec1[0])));
			fRec98[0] = (0 - (((fSlow146 * fRec98[1]) + (fSlow147 * fRec98[2])) - (fSlow348 * fRec1[0])));
			fRec99[0] = (0 - (((fSlow141 * fRec99[1]) + (fSlow142 * fRec99[2])) - (fSlow349 * fRec1[0])));
			fRec100[0] = (0 - (((fSlow136 * fRec100[1]) + (fSlow137 * fRec100[2])) - (fSlow350 * fRec1[0])));
			fRec101[0] = (0 - (((fSlow131 * fRec101[1]) + (fSlow132 * fRec101[2])) - (fSlow351 * fRec1[0])));
			fRec102[0] = (0 - (((fSlow126 * fRec102[1]) + (fSlow127 * fRec102[2])) - (fSlow352 * fRec1[0])));
			fRec103[0] = (0 - (((fSlow121 * fRec103[1]) + (fSlow122 * fRec103[2])) - (fSlow353 * fRec1[0])));
			fRec104[0] = (0 - (((fSlow116 * fRec104[1]) + (fSlow117 * fRec104[2])) - (fSlow354 * fRec1[0])));
			fRec105[0] = (0 - (((fSlow111 * fRec105[1]) + (fSlow112 * fRec105[2])) - (fSlow355 * fRec1[0])));
			fRec106[0] = (0 - (((fSlow106 * fRec106[1]) + (fSlow107 * fRec106[2])) - (fSlow356 * fRec1[0])));
			fRec107[0] = (0 - (((fSlow101 * fRec107[1]) + (fSlow102 * fRec107[2])) - (fSlow357 * fRec1[0])));
			fRec108[0] = (0 - (((fSlow96 * fRec108[1]) + (fSlow97 * fRec108[2])) - (fSlow358 * fRec1[0])));
			fRec109[0] = (0 - (((fSlow91 * fRec109[1]) + (fSlow92 * fRec109[2])) - (fSlow359 * fRec1[0])));
			fRec110[0] = (0 - (((fSlow86 * fRec110[1]) + (fSlow87 * fRec110[2])) - (fSlow360 * fRec1[0])));
			fRec111[0] = (0 - (((fSlow81 * fRec111[1]) + (fSlow82 * fRec111[2])) - (fSlow361 * fRec1[0])));
			fRec112[0] = (0 - (((fSlow76 * fRec112[1]) + (fSlow77 * fRec112[2])) - (fSlow362 * fRec1[0])));
			fRec113[0] = (0 - (((fSlow71 * fRec113[1]) + (fSlow72 * fRec113[2])) - (fSlow363 * fRec1[0])));
			fRec114[0] = (0 - (((fSlow66 * fRec114[1]) + (fSlow67 * fRec114[2])) - (fSlow364 * fRec1[0])));
			fRec115[0] = (0 - (((fSlow61 * fRec115[1]) + (fSlow62 * fRec115[2])) - (fSlow365 * fRec1[0])));
			fRec116[0] = (0 - (((fSlow56 * fRec116[1]) + (fSlow57 * fRec116[2])) - (fSlow366 * fRec1[0])));
			fRec117[0] = (0 - (((fSlow51 * fRec117[1]) + (fSlow52 * fRec117[2])) - (fSlow367 * fRec1[0])));
			fRec118[0] = (0 - (((fSlow46 * fRec118[1]) + (fSlow47 * fRec118[2])) - (fSlow368 * fRec1[0])));
			fRec119[0] = (0 - (((fSlow41 * fRec119[1]) + (fSlow42 * fRec119[2])) - (fSlow369 * fRec1[0])));
			fRec120[0] = (0 - (((fSlow36 * fRec120[1]) + (fSlow37 * fRec120[2])) - (fSlow370 * fRec1[0])));
			fRec121[0] = (0 - (((fSlow31 * fRec121[1]) + (fSlow32 * fRec121[2])) - (fSlow371 * fRec1[0])));
			fRec122[0] = (0 - (((fSlow26 * fRec122[1]) + (fSlow27 * fRec122[2])) - (fSlow372 * fRec1[0])));
			fRec123[0] = (0 - (((fSlow21 * fRec123[1]) + (fSlow22 * fRec123[2])) - (fSlow373 * fRec1[0])));
			fRec124[0] = (0 - (((fSlow16 * fRec124[1]) + (fSlow17 * fRec124[2])) - (fSlow374 * fRec1[0])));
			fRec125[0] = (0 - (((fSlow3 * fRec125[1]) + (fSlow4 * fRec125[2])) - (fSlow375 * fRec1[0])));
			...
			fRec136[0] = (0 - (((fSlow61 * fRec136[1]) + (fSlow62 * fRec136[2])) - (fSlow386 * fRec1[0])));
			...
			fRec168[0] = (0 - (((fSlow306 * fRec168[1]) + (fSlow307 * fRec168[2])) - (fSlow418 * fRec1[0])));
			fRec169[0] = (0 - (((fSlow311 * fRec169[1]) + (fSlow312 * fRec169[2])) - (fSlow419 * fRec1[0])));
			fRec170[0] = (0 - (((fSlow301 * fRec170[1]) + (fSlow302 * fRec170[2])) - (fSlow420 * fRec1[0])));
			fRec171[0] = (0 - (((fSlow296 * fRec171[1]) + (fSlow297 * fRec171[2])) - (fSlow421 * fRec1[0])));
			fRec172[0] = (0 - (((fSlow291 * fRec172[1]) + (fSlow292 * fRec172[2])) - (fSlow422 * fRec1[0])));
			fRec173[0] = (0 - (((fSlow286 * fRec173[1]) + (fSlow287 * fRec173[2])) - (fSlow423 * fRec1[0])));
			fRec174[0] = (0 - (((fSlow281 * fRec174[1]) + (fSlow282 * fRec174[2])) - (fSlow424 * fRec1[0])));
			fRec175[0] = (0 - (((fSlow276 * fRec175[1]) + (fSlow277 * fRec175[2])) - (fSlow425 * fRec1[0])));
			fRec176[0] = (0 - (((fSlow271 * fRec176[1]) + (fSlow272 * fRec176[2])) - (fSlow426 * fRec1[0])));
			fRec177[0] = (0 - (((fSlow266 * fRec177[1]) + (fSlow267 * fRec177[2])) - (fSlow427 * fRec1[0])));
			fRec178[0] = (0 - (((fSlow261 * fRec178[1]) + (fSlow262 * fRec178[2])) - (fSlow428 * fRec1[0])));
			fRec179[0] = (0 - (((fSlow256 * fRec179[1]) + (fSlow257 * fRec179[2])) - (fSlow429 * fRec1[0])));
			fRec180[0] = (0 - (((fSlow251 * fRec180[1]) + (fSlow252 * fRec180[2])) - (fSlow430 * fRec1[0])));
			fRec181[0] = (0 - (((fSlow246 * fRec181[1]) + (fSlow247 * fRec181[2])) - (fSlow431 * fRec1[0])));
			fRec182[0] = (0 - (((fSlow241 * fRec182[1]) + (fSlow242 * fRec182[2])) - (fSlow432 * fRec1[0])));
			fRec183[0] = (0 - (((fSlow237 * fRec183[2]) + (fSlow236 * fRec183[1])) - (fSlow433 * fRec1[0])));
			fRec184[0] = (0 - (((fSlow231 * fRec184[1]) + (fSlow232 * fRec184[2])) - (fSlow434 * fRec1[0])));
			fRec185[0] = (0 - (((fSlow226 * fRec185[1]) + (fSlow227 * fRec185[2])) - (fSlow435 * fRec1[0])));
			fRec186[0] = (0 - (((fSlow221 * fRec186[1]) + (fSlow222 * fRec186[2])) - (fSlow436 * fRec1[0])));
